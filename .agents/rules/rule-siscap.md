...
resources/views/pdfexports → The structures of all pdf exports (using DomPDF). 
...
- Don't use React, TailwindCSS or other previously not defined frameworks / dependencies.
- If you see any file using React logic, notify in chat and propose plan to re-adapt the logic to be more compatible with the app.
