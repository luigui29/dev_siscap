<div>
    <!-- Sumas de programaciones segun estado de aprobación -->
    <div class="row">
        <div class="col-6 mb-2">
            <div class="card stat-card total-1 p-3 shadow-sm h-100">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <div class="text-muted font-weight-bold text-uppercase mb-1" style="font-size: 0.75rem;">Totales</div>
                        <h3 class="mb-0 font-weight-bold text-dark">{{ $totales_program }}</h3>
                    </div>
        ...
        <div class="col-6 mb-2">
            <div class="card stat-card total-2 p-3 shadow-sm h-100">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <div class="text-muted font-weight-bold text-uppercase mb-1" style="font-size: 0.75rem;">Aprobadas</div>
                        <h3 class="mb-0 font-weight-bold text-dark">{{ $totales_program_aprob }}</h3>
                    </div>
        ...
        <div class="col-6 mb-2">
            <div class="card stat-card total-4 p-3 shadow-sm h-100">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <div class="text-muted font-weight-bold text-uppercase mb-1" style="font-size: 0.75rem;">Rechazadas</div>
                        <h3 class="mb-0 font-weight-bold text-dark">{{ $totales_program_recha }}</h3>
                    </div>
        ...
        <div class="col-6 mb-2">
            <div class="card stat-card total-3 p-3 shadow-sm h-100">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <div class="text-muted font-weight-bold text-uppercase mb-1" style="font-size: 0.75rem;">Pendientes</div>
                        <h3 class="mb-0 font-weight-bold text-dark">{{ $totales_program_pend }}</h3>
                    </div>
