            ...
            <div class="modal-body py-5">
                <div class="row p-4">
                    <div class="col-4 mb-4">
                        ...
                        <input id="nivel_educativo" type="text" wire:model="nivel_educativo" class="form-control form-control-md" placeholder="Ej: Bachillerato, Licenciatura..." style="border-radius: 4px;">
                    </div>
                    <div class="col-4 mb-4">
                        ...
                        <input id="titulo" type="text" wire:model="titulo" class="form-control form-control-md" placeholder="Ej: Bachiller, Licenciado..." style="border-radius: 4px;">
                    </div>
                    <div class="col-4 mb-4">
                        ...
                        <input id="especialidad" type="text" wire:model="especialidad" class="form-control form-control-md" placeholder="Ej: Ciencias, Administración..." style="border-radius: 4px;">
                    </div>
                    <div class="col-3 mb-4">
                        ...
                        <input id="instituto" type="text" wire:model="instituto" class="form-control form-control-md" placeholder="Nombre de la institución, universidad..." style="border-radius: 4px;">
                    </div>
                    ...
                    <div class="col-3 mt-4">
                        ...
                        <input id="fecha_culminado" type="number" wire:model="fecha_culminado" step="10" min="0" max="9999" class="form-control form-control-md" placeholder="Ingrese el año de culminación" style="border-radius: 4px;">
                    </div>
                </div>    
            </div>
